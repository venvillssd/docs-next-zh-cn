...
- [单文件组件组合式 API 语法糖 (`<script setup>`)](https://github.com/vuejs/rfcs/blob/6478fe08bba262d09ac40aed9fa2abdeff875879/active-rfcs/0000-script-setup.md) <Badge text="实验性" type="warning" />
